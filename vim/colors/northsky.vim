...
"hi Normal	guifg=white guibg=#ffffff gui=none
...
hi ColorColumn  guifg=NONE ctermfg=NONE guibg=#372725 ctermbg=7 gui=NONE
...
hi LineNr	guifg=DarkGreen guibg=NONE gui=none
...
hi CursorLine	term=bold cterm=bold guifg=NONE guibg=#Grey40 gui=none
...
if exists('g:CtermAttrs') && g:CtermAttrs
  "hi Normal	ctermfg=lightgray ctermbg=black cterm=none
	hi Normal	ctermfg=white ctermbg=blue =none
  ...
  hi Search	ctermfg=3 ctermbg=172 cterm=NONE
  ...
  hi Folded	ctermfg=4 cterm=NONE
  ...
  hi StatusLine	ctermfg=11 ctermbg=32 cterm=NONE
  ...
  hi Constant	ctermfg=32 cterm=NONE
 " hi Number	ctermfg=34 cterm=bold
  hi Number	ctermfg=87 cterm=bold
  ...
  hi Type    	ctermfg=136 cterm=bold
  ...
  hi LineNr	ctermfg=31 cterm=NONE
  ...
  hi TabLine	ctermfg=7 ctermbg=15 cterm=none
  hi TabLineSel ctermfg=11 ctermbg=32 cterm=none
  hi TabLineFill cterm=reverse
endif
